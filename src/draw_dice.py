...
class DrawDice:
    def __init__(self):
        ...
        self.side_1 = pygame.transform.scale(self.side_1, (self.dice_size, self.dice_size))
        self.side_2 = pygame.transform.scale(self.side_2, (self.dice_size, self.dice_size))
        self.side_3 = pygame.transform.scale(self.side_3, (self.dice_size, self.dice_size))
        self.side_4 = pygame.transform.scale(self.side_4, (self.dice_size, self.dice_size))
        self.side_5 = pygame.transform.scale(self.side_5, (self.dice_size, self.dice_size))
        self.side_6 = pygame.transform.scale(self.side_6, (self.dice_size, self.dice_size))
