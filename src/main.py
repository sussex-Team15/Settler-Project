...
class StartMenu:
    ...
    :type  checked : bool
    :param type_active: A flag indicating if the input box is currently active.
    :type type_active: bool 
    :param checkbox_rect:The rectangle of the checkbox for AI player
    :type checkbox_rect: pygame.Rect
    :param checked: A flag indicating if the checkbox is checked.
    ...
    def draw(self, screen):
        ...
        :param: The game screen to draw on.
...
class SpecialRoundGameState(): # gamestate for the first 2 turns of the game (players can build 1 road and settlement free)
    ...
    :type road_2: list
    :param settlement_img: The image of
    """
    ...
    def handle_events(self, events):
        ...
        :param event: A list of pygame events.
        :type event: List 
        """
        turn_taken = None
    ...
    def draw_lines(self):
        """Draws the lines between the nodes on the game board. This method iterates over all tiles on the board and draws the six lines 
...
class ChooseResources:
    """
    A class representing the state of the game when a player chooses which resources to offer
    in a trade with another player or with the bank.

    :param player: The player making the trade offer.
    :type player: Player
    :param trade_partner: The other player involved in the trade, if there is one. If there is no
        trade partner, the player is trading with the bank.
    :type trade_partner: Player or None
    :param player: The player making the trade offer.
    :type player: Player
    :param trade_partner: The other player involved in the trade, if there is one. If there is no
        trade partner, the player is trading with the bank.
    ...
    :param current_state: The current state of the game.
    :type current_state: GameState or None
    :param submit_button: A rectangle representing the "Submit" button on the screen.
    :type submit_button: pygame.Rect
    :param resource_buttons: A list of all the resource images on the screen.
    :type resource_buttons: list
    :param back_button: A rectangle representing the "Back" button on the screen.
    :type back_button: pygame.Rect
    :param offered_resources: The list of resources the player is offering in the trade.
    :type offered_resources: list
    :param plus_buttons: A list of all the "+" buttons on the screen.
    :type plus_buttons: list
    :param minus_buttons: A list of all the "-" buttons on the screen.
    :type minus_buttons: list
    """
    ...
    def handle_events(self, events):
        """
        Handles user events while the player is choosing which resources to offer in a trade.
    ...
    def draw(self, screen):
        """
        :param screen: The surface on which to draw the game screen.
...
class ChooseDesiredResources:
    ...
    def handle_events(self, events):
        """
        Handle user events for choosing desired resources in a trade.
...
class DevelopmentCardState:
    """
    Represents the state of the game where the player has a development card
